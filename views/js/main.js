...
var resizePizzas = function(size) {
  ...
  function changePizzaSizes(size) {
    // set randomPizzaContainer to a variable
    var randomPizzaContainer = document.getElementsByClassName("randomPizzaContainer");
    // vars dx and newwidth moved out of for loop as they do not need to be accessed each time
...
// var items moved outside of function so that it is not run on every scroll
var items = document.getElementsByClassName('mover');
function updatePositions() {
  frame++;
  window.performance.mark("mark_start_frame");
  // set document.body.scrollTop as a variable
